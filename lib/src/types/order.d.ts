...
export type TenderType = "CARD" | "CASH" | "THIRD_PARTY_CARD" | "GIFT_CARD" | "NO_SALE" | "ACCOUNT" | "OTHER";
export type CardBrand = "VISA" | "MASTERCARD" | "AMERICAN_EXPRESS" | "INTERAC" | "DISCOVER" | "JCB" | "CHINA_UNIONPAY" | "OTHER_BRAND";
export type CardEntryMethod = "KEYED" | "SWIPED" | "EMV" | "CONTACTLESS" | "ON_FILE";
export type PaymentStatus = "AUTHORIZED" | "CAPTURED" | "VOIDED" | "FAILED";
export type OrderState = "OPEN" | "COMPLETED" | "CANCELED" | "DRAFT";
export type DiscountType = "FIXED_AMOUNT" | "FIXED_PERCENTAGE" | "VARIABLE_AMOUNT" | "VARIABLE_PERCENTAGE";
